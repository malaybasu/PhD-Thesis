...
unset label
unset arrow
set arrow 1 from 14, 0.5, 0 to 12, 0.5, 0  back linetype 1 linewidth 1.000
set arrow 2 from 16, 1, 0 to 14, 1, 0  back linetype 1 linewidth 1.000
set arrow 3 from 18, 1.5, 0 to 16, 1.5, 0  back linetype 1 linewidth 1.000
set arrow 4 from 21, 1.7, 0 to 19, 1.7, 0  back linetype 1 linewidth 1.000
set arrow 5 from 37, 0.5, 0 to 39, 0.5, 0  back linetype 1 linewidth 1.000
set arrow 6 from 42, 1, 0 to 44, 1, 0  back linetype 1 linewidth 1.000
set arrow 7 from 46, 1.5, 0 to 48, 1.5, 0  back linetype 1 linewidth 1.000
set arrow 8 from 49, 1.7, 0 to 51, 1.7, 0  back linetype 1 linewidth 1.000
unset style line
unset logscale
set offsets 0, 0, 0, 0
set pointsize 1
...
set my2tics default
set mcbtics default
set xtics border nomirror norotate 0.000000,5,60.0000
...
set loadpath 
plot "growth.txt" using 1:($1 > 0?$2:1/0) smooth csplines lw 3, "growth.txt" using 1:($1 > 0?$2:1/0) with points pt 7 ps 0.75 lw 0.5, "growth.txt" using 5:6 smooth csplines lw 3, "growth.txt" using 5:6 with points pt 71 ps .75 lw 0.5
#    EOF
