...
unset key
unset label
set label 1 "p4C12" at 0.3, 55, 0 left norotate font "Myriad-Bold" back linetype 1 pointtype 1 offset 1.000000,1.000000
set label 2 "pDB18R" at 0.6, 45, 0 left norotate font "Myriad-Bold" back linetype 1 pointtype 1 offset 1.000000,1.000000
set label 3 "pBluescriptII KS+" at 0.8, 35, 0 left norotate font "Myriad-Bold" back linetype 1 pointtype 1 offset 1.000000,1.000000
unset arrow
unset style line
unset logscale
set offsets 0, 0, 0, 0
...
set xlabel "OD (600 nm)" 0.000000,0.000000  "Myriad-Bold"
set x2label "" 0.000000,0.000000  ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "{/Symbol b}-galactosidase activity (Miller units)" 0.000000,0.000000  "Myriad-Bold"
...
set loadpath 
plot "zk918.txt" using 1:2 smooth csplines lw 4, "zk918.txt" using 1:2 with points ps 0.5 pt 70 lw 0.5,"zk918.txt" using 3:4 smooth csplines lw 4, "zk918.txt" using 3:4 with points ps 0.5 pt 71 lw 0.5, "zk918.txt" using 5:6 smooth csplines lw 4, "zk918.txt" using 5:6 with points ps .75 pt 72 lw 0.5
#    EOF
