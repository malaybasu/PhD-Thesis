...
unset key
unset label
set label 1 "(null)" at 0, 0, 0 left norotate back linetype 1 pointtype 1 offset 1.000000,1.000000
unset arrow
unset style line
unset logscale
set offsets 0, 0, 0, 0
...
set my2tics default
set mcbtics default
set xtics border nomirror norotate 0.000000,0.5,1.50000
...
set xrange [ 0.250000 : 1.75000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Catalase activity\n({/Symbol m}mol of H_{2}O_{2} decomposed/min/mg of protein)" 0.000000,0.000000  ""
set y2label "" 0.000000,0.000000  ""
set yrange [ 0.000000 : 80.0000 ] noreverse nowriteback
...
set loadpath 
plot "catalase.txt" using 1:2 with lines lw 3, "catalase.txt" using 1:2 with points pt 70 lw .5 ps .7, "catalase.txt" using 1:3 with lines lw 3, "catalase.txt" using 1:3 with points pt 5 ps .7 lw .5, "catalase.txt" using 1:4 with lines lw 3, "catalase.txt" using 1:4 with points pt 71 ps .75 lw .5, "catalase.txt" using 1:5 with lines lw 3, "catalase.txt" using 1:5 with points pt 7 ps .75 lw.5
#    EOF
