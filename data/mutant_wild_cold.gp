...
# set terminal postscript portrait enhanced monochrome blacktext \
   ...
   "Myriad-Bold" 8
# set output 'mutant_wild_cold.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set ytics border nomirror norotate 0.000000,0.25,2.00000
...
set loadpath 
plot "mutant_wild.txt" using 5:6 smooth csplines lw 3, "mutant_wild.txt" using 5:6 with points pt 70 ps .7 lw .5, "mutant_wild.txt" using 7:8 smooth csplines lw 3, "mutant_wild.txt" using 7:8 with points pt 71 ps .7 lw .5
#    EOF
