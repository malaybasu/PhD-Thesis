...
set xlabel "Time (h)" 0.000000,0.000000  "Myriad-Bold"
set x2label "" 0.000000,0.000000  ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "OD (600 nm)" 1.000000,0.000000  "Myriad-Bold"
...
set loadpath 
plot "csid.txt" using 1:2 smooth csplines lw 3, "csid.txt" using 1:2 with points ps 0.75 pt 70 lw 0.5, "csid.txt" using 1:3 smooth csplines lw 3, "csid.txt" using 1:3 with points ps 0.75 pt 71 lw .5, "csid.txt" using 1:4 smooth csplines lw 3, "csid.txt" using 1:4 with points ps .75 pt 72 lw .5
#    EOF
