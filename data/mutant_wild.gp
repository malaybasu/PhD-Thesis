...
set ytics border nomirror norotate 0.000000,0.5,2.00000
...
set loadpath 
plot "mutant_wild.txt" using ($1>0?$1:1/0):2 smooth csplines lw 3,"mutant_wild.txt" using ($1>0?$1:1/0):2 with points pt 70 ps .7 lw .5, "mutant_wild.txt" using ($3>0?$3:1/0):4 smooth csplines lw 3 lt 2, "mutant_wild.txt" using ($3>0?$3:1/0):4 with points pt 71 ps .7 lw .5, "mutant_wild.txt" using 5:6 smooth csplines lw 3 lt 1, "mutant_wild.txt" using 5:6 with points pt 5 ps .7 lw .5, "mutant_wild.txt" using 7:8 smooth csplines lw 3 lt 2, "mutant_wild.txt" using 7:8 with points pt 7 lw .5 ps .7
#    EOF
