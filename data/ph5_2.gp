...
set my2tics default
set mcbtics default
set xtics border nomirror norotate 0.000000,20,100.000
set ytics border nomirror norotate 0.000000,0.5,3.00000
...
set xrange [ 0.000000 : 100.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "OD (600 nm)" 1.000000,0.000000  ""
set y2label "" 0.000000,0.000000  ""
set yrange [ 0.000000 : 3.00000 ] noreverse nowriteback
...
set loadpath 
plot "ph5.txt" using 6:5 smooth csplines lw 3, "ph5.txt" using 6:5 with points pt 70 ps .7 lw .5, "ph5.txt" using 8:7 smooth csplines lw 3, "ph5.txt" using 8:7 with points pt 71 ps .7 lw .5
#    EOF
