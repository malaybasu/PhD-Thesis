...
set ytics border nomirror norotate 0.000000,0.5,3.50000
...
set yrange [ 0.000000 : 3.50000 ] noreverse nowriteback
...
set loadpath 
plot "ph5.txt" using 3:($1>0?$1:1/0) smooth csplines lw 3, "ph5.txt" using 3:($1 >0?$1:1/0) with points pt 70 ps .7 lw .5, "ph5.txt" using 4:($2>0?$2:1/0) smooth csplines lw 3, "ph5.txt" using 4:($2>0?$2:1/0) with points pt 71 ps .7 lw .5
#    EOF
