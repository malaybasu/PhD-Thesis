...
set loadpath 
plot "osmy.txt" using 1:2 smooth csplines lw 3, "osmy.txt" using 1:2 with points ps 0.75 pt 70 lw 0.5, "osmy.txt" using 1:3 smooth csplines lw 3, "osmy.txt" using 1:3 with points ps 0.75 pt 71 lw .5, "osmy.txt" using 1:4 smooth csplines lw 3, "osmy.txt" using 1:4 with points ps .75 pt 72 lw .5
#    EOF
