...
set my2tics default
set mcbtics default
set xtics border nomirror norotate 0.000000,0.25,2.00000
...
set ylabel "{/Symbol b}-galactosidase activity (Miller units)" 1.000000,0.000000  "Myriad-Bold"
...
set loadpath 
plot "csid.txt" using 2:($2 > 0.5 ? $11 : 1/0)  smooth csplines lw 3, "csid.txt" using 2:($2 > .5 ? $11 : 1/0) with points ps 0.75 pt 70 lw 0.5, "csid.txt" using 3:($3 > .5? $12 :1/0) smooth csplines lw 3, "csid.txt" using 3:($3 >.5?$12 :1/0) with points ps 0.75 pt 71 lw .5, "csid.txt" using 4:($4 > .5?$13:1/0) smooth csplines lw 3, "csid.txt" using 4:($4 >.5?$13 :1/0) with points ps .75 pt 72 lw .5
#    EOF
